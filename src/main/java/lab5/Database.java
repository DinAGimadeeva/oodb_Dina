...
class Database {
  ...
  void saveToDB() {
    ...
    final String SQL_INPUT1 = "INSERT INTO authors (author) VALUES (ROW('Лев', 'Николаевич', 'Толстой','Писатель, годы жизни 1828-1910')) returning id";
  ...
  void update(){
      ...
      final String SQL_UPDATE1 = "UPDATE authors SET author.names = 'Лев' WHERE id=1 returning id";
